...
/// Warm, heart-centered color palette for blood donation app
class LightModeColors {
  // Primary: Vibrant red for life-saving theme
  static const lightPrimary = Color(0xFFE53935);
  static const lightOnPrimary = Color(0xFFFFFFFF);
  static const lightPrimaryContainer = Color(0xFFFFEBEE);
  static const lightOnPrimaryContainer = Color(0xFF8B0000);

  // Secondary: Soft coral for warmth
  static const lightSecondary = Color(0xFFFF7961);
  static const lightOnSecondary = Color(0xFFFFFFFF);

  // Tertiary: Deep rose accent
  static const lightTertiary = Color(0xFFC62828);
...
class DarkModeColors {
  // Primary: Softer red for dark background
  static const darkPrimary = Color(0xFFFF8A80);
  static const darkOnPrimary = Color(0xFF5F0000);
  static const darkPrimaryContainer = Color(0xFFB71C1C);
  static const darkOnPrimaryContainer = Color(0xFFFFDAD6);

  // Secondary
  static const darkSecondary = Color(0xFFFFAB91);
  static const darkOnSecondary = Color(0xFF442B2D);

  // Tertiary
  static const darkTertiary = Color(0xFFEF5350);
  static const darkOnTertiary = Color(0xFF3E1414);
